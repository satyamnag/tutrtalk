...
// NEW: Correct import for Krisp hook as per official docs
...
export function AgentControlBar({
  ...
  // NEW: Krisp Noise Cancellation Hook
  const { 
        ...
        <div className="flex grow gap-1">
          ...
          {visibleControls.noiseCancellation && (
            <Toggle
              ...
              onPressedChange={setNoiseFilterEnabled}
